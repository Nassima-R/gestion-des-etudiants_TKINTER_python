...
class Table:
    def __init__(self, c1):
        self.canvas=Canvas(c1,height=800,width=610)
        ...
        for i in range(lnom):
            for j in range(colnom):
                e=Entry(frame,width=10,fg='black',font=('Arial',16,'bold'))
                e.grid(row=i+1,column=j+1)
                e.insert(END,Headstr[i][j])
        for i in range(l):
            for j in range(col):
                e=Entry(frame,width=10,fg='black',font=('Arial',16))
                e.grid(row=i+2,column=j+1)
                e.insert(END,lst[i][j])
def ajouter():
    sql1='INSERT INTO etudiant VALUES (%s,%s,%s,%s,%s,%s,%s)'
    sql2='INSERT INTO inscri VALUES(%s,%s,%s,%s,%s)'
    #if v1.get()!='' and v2.get()!='' and v3.get()!='' and v4.get()!='' and v5.get()!='' and v6.get()!='' :
    ...
    if vv2.get()=='M1CP':b.execute(sql3,(v1.get(),'G_M1CP'))
    elif vv2.get()=='M2CP':b.execute(sql3,(v1.get(),'G_M2CP'))
    elif vv2.get()=='M3CP':b.execute(sql3,(v1.get(),'G_M3CP'))
    elif vv2.get()=='M3CD':b.execute(sql3,(v1.get(),'G_M3CD'))
    elif vv2.get()=='P3CD':b.execute(sql3,(v1.get(),'G_P3CD'))
    elif vv2.get()=='P1CP':b.execute(sql3,(v1.get(),'G_P1CP'))
    elif vv2.get()=='P2CP':b.execute(sql3,(v1.get(),'G_P2CP'))
    elif vv2.get()=='P3CP':b.execute(sql3,(v1.get(),'G_P3CP'))
    elif vv2.get()=='M1LP':b.execute(sql3,(v1.get(),'G_M1LP'))
    elif vv2.get()=='M2LP':b.execute(sql3,(v1.get(),'G_M2LP'))
    elif vv2.get()=='M2LD':b.execute(sql3,(v1.get(),'G_M2LD'))
    elif vv2.get()=='M3LP':b.execute(sql3,(v1.get(),'G_M3LP'))
    elif vv2.get()=='M3LD':b.execute(sql3,(v1.get(),'G_M3LD'))
    elif vv2.get()=='P1LP':b.execute(sql3,(v1.get(),'G_P1LP'))
    elif vv2.get()=='P2LP':b.execute(sql3,(v1.get(),'G_P2LP'))
    elif vv2.get()=='P3LP':b.execute(sql3,(v1.get(),'G_P3LP'))
    elif vv2.get()=='P2LD':b.execute(sql3,(v1.get(),'G_P2LD'))
    elif vv2.get()=='P3LD':b.execute(sql3,(v1.get(),'G_P3LD'))
    elif vv2.get()=='SVT1CP':b.execute(sql3,(v1.get(),'G_SVT1CP'))
    elif vv2.get()=='SVT2CP':b.execute(sql3,(v1.get(),'G_SVT2CP'))
    elif vv2.get()=='SVT3CP':b.execute(sql3,(v1.get(),'G_SVT3CP'))
    elif vv2.get()=='SVT3CD':b.execute(sql3,(v1.get(),'G_SVT3CD'))
    elif vv2.get()=='SVT1LP':b.execute(sql3,(v1.get(),'G-SVT1LP'))
    elif vv2.get()=='SVT2LP':b.execute(sql3,(v1.get(),'G_SVT2LP'))
    elif vv2.get()=='SVT3LP':b.execute(sql3,(v1.get(),'G_SVT3LP'))
    elif vv2.get()=='SVT2LD':b.execute(sql3,(v1.get(),'G_SVT2LP'))
    elif vv2.get()=='SVT3LD':b.execute(sql3,(v1.get(),'G_SVT3LD'))
    elif vv2.get()=='HG':b.execute(sql3,(v1.get(),'G_HG'))
    elif vv2.get()=='AR':b.execute(sql3,(v1.get(),'G_AR'))
    elif vv2.get()=='EI':b.execute(sql3,(v1.get(),'G_EI'))
    elif vv2.get()=='FR':b.execute(sql3,(v1.get(),'G_FR'))
    elif vv2.get()=='ANG':b.execute(sql3,(v1.get(),'G_ANG'))
    elif vv2.get()=='FRL':b.execute(sql3,(v1.get(),'G_FRL'))
    elif vv2.get()=='ANGL':b.execute(sql3,(v1.get(),'G_ANGL'))
    elif vv2.get()=='TRD':b.execute(sql3,(v1.get(),'G_TRD'))
    elif vv2.get()=='E_CO':b.execute(sql3,(v1.get(),'G_E_CO'))
    elif vv2.get()=='DVP':b.execute(sql3,(v1.get(),'G_DVP'))
    elif vv2.get()=='D_WEB':b.execute(sql3,(v1.get(),'G_D_WEB'))
    elif vv2.get()=='PHILO':b.execute(sql3,(v1.get(),'G_PHILO'))
    a0.commit()
...
def inscrilangue():
    ...
    Label(b, text='LE NOMBRE DE SEANCE :', fg='black',bg='#CACFD2',font=('comforta',15)).place(x=1000, y=350)
    vv1=StringVar()
    vv2=ttk.Combobox(b,textvariable=vv1,values=('CHL','ANGL','FRL'),width=50,height=8);vv2.place(x=1000,y=190)
    vv2.current(0)
    vv3=IntVar()
...
def selcsoft():
    ...
    b.execute("select e.nom,e.prenom from etudiant e,inscrit i,formation f where e.CIN=i.CIN and i.id_formation=f.id_formation and f.categorie='soft skils'")
...
def selclangue():
    ...
    global lnom,lst,Headstr,colnom,l,col
    Label(c,text='voici la liste des etudiant inscri',font=('comforta',20),bg='black',fg='white').grid(row=0,column=0)
    b.execute("select e.nom,e.prenom,i.id_formation from etudiant e,inscrit i,formation f where e.CIN=i.CIN and i.id_formation=f.id_formation and f.categorie='langue'")
    Headstr=[b.column_names]
    lnom=len(Headstr)
    colnom=len(Headstr[0])
    lst=b.fetchall()
...
def selcsoutiens():
    ...
    global lnom,lst,Headstr,colnom,l,col
    Label(c,text='voici la liste des etudiant inscri',font=('comforta',20),bg='black',fg='white').grid(row=0,column=0)
    b.execute("select e.nom,e.prenom from etudiant e,inscrit i,formation f where e.CIN=i.CIN and i.id_formation=f.id_formation and f.categorie='soutien scolaire'")
    Headstr=[b.column_names]
    lnom=len(Headstr)
    colnom=len(Headstr[0])
    lst=b.fetchall()
...
def requet():
    ...
    Button(r,text="revenu annulle",command=revenu,bg='#1b4f72',fg='white',bd=4,cursor='hand2',width='40',height='2',font=('comforta',15)).place(x=200,y=350)
    ...
    Button(r,text="afficher les etudiants qui ont termine leurs seances",command=aff,bg='#1b4f72',fg='white',bd=4,cursor='hand2',width='40',height='2',font=('comforta',15)).place(x=900,y=450)
    Button(r,text="afficher les etudiants d'un groupe",command=affgrp,bg='#1b4f72',fg='white',bd=4,cursor='hand2',width='40',height='2',font=('comforta',15)).place(x=900,y=150)
    ...
    #Button(r,text="afficher les profs de specialite precis",bg='#1b4f72',fg='white',bd=4,cursor='hand2',width='40',height='2',font=('comforta',15)).place(x=900,y=400)
    #Button(r,text="afficher les etudiants qui ont terminer leurs seances",bg='#1b4f72',fg='white',bd=4,cursor='hand2',width='40',height='2',font=('comforta',15)).place(x=900,y=500)
    Button(r,command=r.destroy,text='EXIT',fg='#154360',bg='#FFA000',bd=4,cursor='hand2',width='30',height='2',font=('comforta',10)).place(x=650,y=650)
...
def grouplangue():
    ...
    b.execute("select a.id_grp,f.categorie from appartient a,inscrit i,formation f where a.CIN=i.CIN and f.id_formation=i.id_formation and f.categorie='langue'")
    Headstr=[b.column_names]
    lnom=len(Headstr)
    colnom=len(Headstr[0])
    lst=b.fetchall()
...
def groupsoft():
    ...
    global lnom,lst,Headstr,colnom,l,col
    Label(c1,text='voici la liste de nos groupes',font=('comforta',20),bg='black',fg='white').grid(row=0,column=0)
    b.execute("select a.id_grp,f.categorie from appartient a,inscrit i,formation f where a.CIN=i.CIN and f.id_formation=i.id_formation and f.categorie='soft skils'")
    Headstr=[b.column_names]
    lnom=len(Headstr)
    colnom=len(Headstr[0])
    lst=b.fetchall()
...
def groupsoutiens():
    ...
    global lnom,lst,Headstr,colnom,l,col
    Label(c1,text='voici la liste de nos groupes',font=('comforta',20),bg='black',fg='white').grid(row=0,column=0)
    b.execute("select a.id_grp,f.categorie from appartient a,inscrit i,formation f where a.CIN=i.CIN and f.id_formation=i.id_formation and f.categorie='soutien scolaire")
    Headstr=[b.column_names]
    lnom=len(Headstr)
    colnom=len(Headstr[0])
    lst=b.fetchall()
...
def enattdsoftskills():
    ...
    b.execute("SELECT e.nom,e.prenom FROM etudiant e,inscrit i,formation f WHERE NOT EXISTS (  SELECT 1 FROM appartient WHERE appartient.CIN=e.CIN) and e.CIN=i.CIN and i.id_formation=f.id_formation and f.categorie='soft skils'")
    Headstr=[b.column_names]
    lnom=len(Headstr)
    colnom=len(Headstr[0])
    lst=b.fetchall()
...
def enattdlangues():
    ...
    global lnom,lst,Headstr,colnom,l,col
    Label(c1,text='voici la liste des etudiant qui attend leur integration',font=('comforta',20),bg='black',fg='white').grid(row=0,column=0)
    b.execute("SELECT e.nom,e.prenom FROM etudiant e,inscrit i,formation f WHERE NOT EXISTS (  SELECT 1 FROM appartient WHERE appartient.CIN=e.CIN) and e.CIN=i.CIN and i.id_formation=f.id_formation and f.categorie='langue'")
    Headstr=[b.column_names]
    lnom=len(Headstr)
    colnom=len(Headstr[0])
    lst=b.fetchall()
...
def enattdsoutiens():
    ...
    global lnom,lst,Headstr,colnom,l,col
    Label(c1,text='voici la liste des etudiant qui attend leur integration',font=('comforta',20),bg='black',fg='white').grid(row=0,column=0)
    b.execute("SELECT e.nom,e.prenom FROM etudiant e,inscri i,formation f WHERE NOT EXISTS (  SELECT 1 FROM appartient WHERE appartient.CIN=e.CIN) and e.CIN=i.CIN and i.id_formation=f.id_formation and f.categorie='soutien scolaire'")
    Headstr=[b.column_names]
    lnom=len(Headstr)
    colnom=len(Headstr[0])
    lst=b.fetchall()
...
def lisprosoutiens():
    ...
    b.execute("select * from formateur where specialite in ('math','pc','svt','anglais','français','hg','ei','philo','arabe') ")
    Headstr=[b.column_names]
    lnom=len(Headstr)
    colnom=len(Headstr[0])
    lst=b.fetchall()
...
def soutiens_scolaires():
   ...
   photo = tk.PhotoImage(file="c:\\Users\\HP\\Downloads\\Transparent (1).png")
   p = tk.Label(fnt4, image=photo)
   p.place(x=360, y=100)
   f1 = tk.Frame(fnt4, width='2000', height='100', background='black')
   f1.place(x=0, y=0)
   lb1 = tk.Label(fnt4, text='BIEN VENU AU SERVISE DE SOUTIENS SCOLAIRE ', height='2', bg='black', fg='white',font=('comforta', 20))
...
def softskills():
   ...
   photo = tk.PhotoImage(file="c:\\Users\\HP\\Downloads\\Skills.png")
...
def langues():
   ...
   photo = tk.PhotoImage(file="c:\\Users\\HP\\Downloads\\0.png")
...
def recherche():
    ...
    f.mainloop()    
def revenu():
    req="""SELECT YEAR(i.date_dinscription) AS annee,((SELECT SUM(paiment) FROM inscri) - (SELECT SUM(salaire) FROM formateur))*12 AS revenue_annuel FROM inscri i JOIN formateur f ON i.id_formation = f.id_formation GROUP BY YEAR(i.date_dinscription)"""
    b.execute(req) 
    res=b.fetchall() 
    message = "Résultats :\n"
    for row in res:
        message += f"Année: {row[0]}, Revenu Annuel: {row[1]}"
    messagebox.showinfo('Message', message)
def rest():
    c1=Tk()
    c1.geometry('2000x900')
    c1.title('liste des groupes')
    c1.config(bg='#263238')
    global lnom,lst,Headstr,colnom,l,col
    Label(c1,text='voici la liste des seance restants pour les etudiant',font=('comforta',20),bg='#263238',fg='white').grid(row=0,column=0)
    b.execute("select i.cin,i.nbr_seance,i.id_formation,a.nbr_presence,a.nbr_absc,i.nbr_seance-a.nbr_presence-a.nbr_absc+1 as nbr_rest from inscri i,assister a where i.CIN=a.CIN" )
    Headstr=[b.column_names]
    lnom=len(Headstr)
    colnom=len(Headstr[0])
    lst=b.fetchall()
...
def pleine():
    ...
    b.execute("SELECT id_grp FROM groupe WHERE nbre_eleve = 8 " )
    Headstr=[b.column_names]
    lnom=len(Headstr)
    colnom=len(Headstr[0])
    lst=b.fetchall()
...
def type():
    ...
    b.execute("SELECT s.jour, s.type FROM seance s JOIN assister a ON s.num_seance = a.num_seance JOIN etudiant e ON a.CIN = e.CIN JOIN inscri i ON e.CIN = i.CIN JOIN formation f ON i.id_formation = f.id_formation" )
    Headstr=[b.column_names]
    lnom=len(Headstr)
    colnom=len(Headstr[0])
    lst=b.fetchall()
...
def show_main_interface():
    ...
    photo1 =tk.PhotoImage(file="c:\\Users\\HP\\Downloads\\professionnelle.png")
    pp1 =tk.Label(fnt1, image=photo1)
    pp1.place(x=40, y=150)

    Lbb1 = tk.Label(fnt1, text='                                                                                        bienvenue                                                                                             ', fg='#3498DB', bg='black', font=('Comforta', 20))
    Lbb1.place(x=5, y=10)

    btt1 = tk.Button(fnt1, text='Centre de langue', fg='white', bg='#3498DB', width='90', height='4',command=langues,)
    btt1.place(x=800, y=370)

    btt2 = tk.Button(fnt1, text='Soft skills', fg='white', bg='#3498DB', width='90', height='4',command=softskills)
    btt2.place(x=800, y=470)

    btt3 = tk.Button(fnt1,text='Cours de soutiens', fg='white', bg='#3498DB', width='90', height='4',command=soutiens_scolaires)
    btt3.place(x=800, y=570)

    Lbb2 = tk.Label(fnt1, text='Sélectionner une catégorie...!!!', fg='black', bg='#F2F3F4', font=('Comforta', 30))
    Lbb2.place(x=850, y=200)
    ...
    bt4= tk.Button(fnt1,command=requet, text="plus d'information...", fg='white', bg='#3498DB', bd=4, cursor='hand2',width='90', height='4').place(x=800, y=670)
...
photo = tk.PhotoImage(file="c:\\Users\\HP\\Downloads\\Learning (1).png")
